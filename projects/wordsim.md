...
* `save_np.py` Reads the word vector file and saves the 2D numpy matrix in file `glove.42B.300d.npy`  and the vocabulary list in `glove.42B.300d.vocab.txt`. Store both files in the same data directory passed into your `save_np.py` script from the command line.
